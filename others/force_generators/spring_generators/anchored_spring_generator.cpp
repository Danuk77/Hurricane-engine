...
void AnchoredSpringGenerator::generate_force(Particle *particle,
  ...
  glm::vec3 force_applied = -spring_constant *
                            (elasticity_maginitude - rest_length) *
                            elasticity_direction;
}
