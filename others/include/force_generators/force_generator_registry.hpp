...
public:
   ...
   * @force_generator The generator used for generating the force on the
   * particle
   */
   ...
   * particle
   */
  void deregister_generator(Particle *particle,
                            ForceGenerator *force_generator);
  ...
  /**
   * Call all force registers to apply forces on the particles they are
   * registered to apply a force to
